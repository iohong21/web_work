...
public class UserActionFactory {
	...
	public Action action(String command){
		...
		*/
		...
		switch(command) {
			case "/fortune": action = new FortuneAction(); break;
			case "/person": action = new PersonAction(); break;
			case "/info": action = new InfoAction(); break;
			case "/test": action = new TestAction(); break;
		}
